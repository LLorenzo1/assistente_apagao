...
def mostrar_tela_branca():
    # Estou criando uma imagem branca para servir de lanterna, (500px de altura, 800px de largura)
    ...
    while True:
        ...
        if cv2.waitKey(1) == 27:  # Para fechar a lanterna basta clicar no ESC para fechar
            break
